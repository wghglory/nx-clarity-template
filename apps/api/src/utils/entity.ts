 ...
 * @param list RDE list
 */
export function addItemToList<T extends RDEEntityState>(
  item: RDEValue<T>,
  list: RDEList<T>
) {
 ...
 * @param list RDE list
 */
export function removeItemFromList<T extends RDEEntityState>(
  id: string,
  list: RDEList<T>
) {
 ...
 */
export function filterResolvedAndSuccessEntity<T extends RDEEntityState>(
  list: RDEList<T>
) {
  return list.values.filter(
    (v) => v.entity.state === 'success' && v.state === 'RESOLVED'
  );
}
 ...
 */
export function filterRDEListByOrgId<T extends RDEEntityState>(
  list: RDEList<T>,
